...
public class CommentRequest extends StringRequest {
    ...
    // 수정 - 3
    public CommentRequest(String type, String _id, String anonymous, String commentBody, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        super(Method.POST,URL, listener, errorListener);
