    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.buttonUpdate: // 수정
                ...
                final int anonymous = myCommentDataArrayList.get(UpdatePosition).getAnonymous();
                ...
                UpdateBuilder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // Volley 로 회원양식 웹으로 전송
                        CommentRequest commentRequest = new CommentRequest(type, String.valueOf(id), String.valueOf(anonymous), comm, resposneListener, errorListener);
                        commentRequest.setShouldCache(false);
